...
public enum ErrorCode {
    ...
    CAPTCHA_REQUIRED(HttpStatus.BAD_REQUEST, "Vui lòng xác thực captcha trước khi tiếp tục"),
    CAPTCHA_STEP_UP_REQUIRED(HttpStatus.BAD_REQUEST, "Độ tin cậy captcha chưa đủ, vui lòng xác thực lại qua captcha v2"),
    ...
    ACCOUNT_LOCKED(HttpStatus.FORBIDDEN, "Tài khoản đang bị tạm khóa, vui lòng thử lại sau vài phút"),
